  ...
  <div class="headernav">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="py-2" href="#">
        ...
        <ul class="navbar-nav">
          <!-- <li><router-link to="/" tag="p" class="nav-link">主页</router-link></li> -->
          <!-- <li><router-link :to="mainLink" class="nav-link">主页</router-link></li> -->
          <li><router-link :to="{name: 'mainLink'}" class="nav-link">主页</router-link></li>
          <li><router-link :to="{name: 'menuLink'}" class="nav-link">菜单</router-link></li>
          <li><router-link :to="{name: 'managerLink'}" class="nav-link">管理</router-link></li>
