<template>
   <div id="taskCenterSubmit-box">
    <!-- 头部部分  -->
      <div class="taskCenterSubmit-title">
   ...
   <!--  <div class="title">
      ...
      <p>
       ...
       <div class="taskCenterSubmit-center">
           <div class="taskCenterSubmit-name">
              <span>{{ info.task_title }}</span>
           </div>
           <div class="taskCenterSubmit-describe">
               <p>
                   <el-upload
     ...
     <!-- 发布任务按钮 -->  
     <div class="taskCenterSubmit-foot">
...
<style>
   ...
   .taskCenterSubmit-title a{
      font-size: 50px;
      color:rgba(0, 0, 0, 1);
      margin-left: 20px;
   }
   .taskCenterSubmit-title h5{
  ...
  /* 中间任务信息样式*/
  .taskCenterSubmit-center{
      height: 500px;
      width: 100%;
      margin-top: 103px;
      background-color: white;
  }
  .taskCenterSubmit-name{
      height: 60px;
      font-size: 26px;
      color: #666;
      width: 96%;
  ...
  .taskCenterSubmit-describe span{
      height: 50px;
      line-height: 50px;
      width: 100%;
  }
  .taskCenterSubmit-describe p{
      height: 160px;
      width: 160px;
      text-align: center;
      margin-top: 20px;
  ...
  .taskCenterSubmit-describe p button{
      height: 80px;
      width: 90px;
      margin-top: 40px;
  ...
  .taskCenterSubmit-describe p .el-upload--picture-card {
  ...
  .taskCenterSubmit-foot button{
   ...
   .taskCenterSubmit-foot button a{
     color: white;
   }
</style>