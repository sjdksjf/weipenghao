<template>
  ...
  <section class="showChose" v-show="showChose">
      ...
      <div class="center">
           <span>当前位置</span>
           <p>
              <img src="http://qn.hangjie888.com/mp1.png">
              <span class="span1">中国&nbsp河南&nbsp郑州</span>
           </p>
      </div>
      <!-- 选择地区部分  -->
      <section class="address">
        ...
        <section class="title">
          ...
          <div class="area saveAdd"@click="saveAddress()">
    ...
    export default {
      ...
      getetle: function(tookin){
        ...
        saveAddress:function(){
          var that = this;
          var arr1 = this.add_cookie;
          var address = this.Province+this.City+this.District;
          var url = '/v1/user/edit_address_id?access_token='+arr1;
           axios.post(url, {
                 address: address
            })
          ...
            .catch(function (error) {
                ...
                if(error.data.code == 200){
                  ...
                  // that.data_git()
                   that.$router.push('/personal/personalData')
                }else{
                   alert(error.data.msg)
                }
